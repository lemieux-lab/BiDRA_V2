...
function doInference(expData::DataFrame, id::String, responseType::Int, posterior_path::String)
  local HDRmixture
  local LDRμ
...
function rankingAnalysis(posterior::DataFrame, N::Int, expId::Vector, paramRank::Int, responseType::Int, ANALYSIS_PATH::String)
  if paramRank == 0
    param = :ic50
  ...
  plotRanking(sorted_rank_matrix, posterior, sorted_pos, expId, N, n_samples, paramRank, ANALYSIS_PATH)
end

function createZip(uniqueID::String, resetPwd::String, UPLOAD_PATH::String, ANALYSIS_PATH::String)
