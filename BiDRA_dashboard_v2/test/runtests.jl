...
# !!! Main.UserApp is configured as an alias for Main.BiDRADashboardV2 and you might encounter it in some tests
using Main.BiDRADashboardV2, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "BiDRADashboardV2 tests" begin
  @includetests ARGS
end
